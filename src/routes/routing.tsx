...
const VerifyAcount = React.lazy(
  () => import("../pages/VerifyAcount/verity-acount")
);
const ResetPassword = React.lazy(
  () => import("../pages/ResetPassword/reset-password")
);
const ChangePasswordWithoutLogin = React.lazy(
  () => import("../pages/ChangePasswordWithoutLogin/change-password")
);
const ProductById = React.lazy(
  () => import("../pages/ProductById/product-by-id")
);
const NotFound = React.lazy(() => import("../pages/NotFound/not-found"));
const MyPurchases = React.lazy(
  () => import("../pages/MyPurchases/my-purchases")
);
const WishList = React.lazy(() => import("../pages/WishList/wish-list"));
const Checkout = React.lazy(() => import("../pages/Checkout/Checkout"));
const SucefullyPurchase = React.lazy(
  () => import("../pages/SucefullyPurchase/sucefully-purchase")
);
      ...
      <Router>
        <React.Suspense fallback={<GlobalLoadingPage />}>
          ...
          <Routes>
            ...
            <Route
              path={paths.changePasswordWithoutLogin}
              element={<ChangePasswordWithoutLogin />}
            />
            ...
            <Route
              path={paths.sucefullyPurchase}
              element={<SucefullyPurchase />}
            />
