...
export type AuthContextType = {
  ...
  verifyAcount: (
    body: IVerifyAcountBody,
    headers?: AxiosRequestHeaders
  ) => AxiosPromise;
  resentVerifyCode: (
    body: IResentVerifyCode,
    headers?: AxiosRequestHeaders
  ) => AxiosPromise;
  resetPassword: (
    body: IResetPassword,
  ...
  changePasswordWithoutLogin: (
    body: IResetPasswordWithoutLogin,
    headers?: AxiosRequestHeaders
  ) => AxiosPromise;
...
export function AuthContextProvider(props: AuthContextProvidersProps) {
  ...
  const [userAdress, setUserAdress] = React.useState<IAdressFormat | undefined>(
    undefined
  );
  ...
  const registerANewAdressOfUser = async (
    body: IRegisterAdressFormat,
    token?: string
  ) => {
  ...
  const changePasswordWithoutLogin = async (
    ...
    const response = await authApi.changePasswordWithoutLogin(
      body,
      headers || {}
    );
    return response;
